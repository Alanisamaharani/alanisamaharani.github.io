...
1. Instalasi Ruby
    ...
    Kunjungi https://rubyinstaller.org/
...
1. Membuat Repository GitHub
    ...
    Buat Repository Baru di GitHub:
        ...
        Beri nama repository dengan format username.github.io, misalnya alisyateriana.github.io Ini adalah nama domain untuk situsmu.
        Pilih public dan jangan centang opsi untuk menambahkan README.
        Klik Create repository.

    Salin URL Repository: Salin URL repository GitHub kamu, misalnya:
...
2. Membuat Situs Jekyll Baru
    ...
    Setelah repository GitHub dibuat, langkah berikutnya adalah membuat situs Jekyll secara lokal di komputer kamu.
     Buat Situs Jekyll Baru: Di terminal/command prompt, jalankan perintah berikut untuk membuat situs Jekyll baru:
    ...
    Pindah ke Direktori Situs: Masuk ke folder situs Jekyll yang baru saja dibuat:
    cd nama-repository
    Verifikasi Situs Secara Lokal: Jalankan situs secara lokal dengan perintah:
    bundle exec jekyll serve
...
3. Menyambungkan Repository GitHub
    ...
    Inisialisasi Git di Direktori Situs: Jika belum, inisialisasi Git di folder situs Jekyll:

    git init
    Hubungkan Repository GitHub: Menambahkan repository GitHub yang baru kamu buat sebagai remote:
    git remote add origin https://github.com/username/username.github.io.git
    Menambahkan dan Meng-commit File: Tambahkan semua file ke staging area dan commit perubahan:
    git add . git commit -m “Initial commit”
    Push ke GitHub: Kirimkan file yang sudah di-commit ke GitHub:
...
4. Mengaktifkan GitHub Pages
    ...
    Masuk ke Pengaturan Repository di GitHub:
    ...
    Selesai!: GitHub akan memproses dan meng-host situs Jekyll kamu. Biasanya, situs akan tersedia di:
...
5. Menyesuaikan Situs Jekyll
    ...
    Konfigurasi _config.yml: Buka file _config.yml dan sesuaikan pengaturan situsmu, seperti nama, deskripsi, dan URL: yaml title: My Personal Web description: This is my personal website hosted on GitHub Pages. url: “https://username.github.io” baseurl: “”
    Menambahkan Postingan Blog atau Halaman Statis:
    ...
    Menambahkan Tema Jekyll: Kamu bisa memilih tema dari Jekyll Themes, lalu menambahkannya ke file _config.yml. Contoh: yaml theme: jekyll-theme-cayman
    Menambahkan Custom CSS dan JavaScript: Kamu juga bisa menambahkan file CSS atau JavaScript untuk memperindah tampilan situs di folder assets/css dan assets/js.
...
6. Update Situs dan Push ke GitHub
    ...
    Tambah dan Commit Perubahan: Setelah melakukan perubahan, jalankan perintah:
    git add . git commit -m “Update site content”
    Push Perubahan ke GitHub: Kirimkan perubahan yang baru saja di-commit ke GitHub:
